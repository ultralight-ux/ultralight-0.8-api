...
enum UExport ShaderType {
  kShaderType_Composite_Layer,
  kShaderType_Draw_Path,
  kShaderType_Draw_Rounded_Rect,
  kShaderType_Draw_Rounded_Rect_Shadow,
  kShaderType_Fill,
  kShaderType_Visualize_Batch,
  kShaderType_Draw_Box_Decorations,
};
